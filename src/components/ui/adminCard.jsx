        ...
        <div className="w-auto ">
            <div className="flex jusitfy-between min-w-[758px]">
                <div className="flex w-full gap-2">
                    ...
                    <div>
                        <h1 className="text-lg font-semibold">SIRAJGANJ GOVT. COLLEGE</h1>
                        <p className="text-sm">SIRAJGANJ SADAR, SIRAJGANJ</p>
                    </div>
                </div>
                <div>
                    <Image src={"/qrcode.svg"} width={50} height={50} alt="qr code"/>
                </div>
            </div>
            <div className="flex justify-center">
                <div className="font-bold border-b-4">Admit Card</div>    
            </div>
            <div className="flex justify-between">

                <div>
                    <div className="grid grid-cols-[140px_10px_1fr] text-l">
                        ...
                        <span className="text-lg font-bold">Exam ID</span>       <span>:</span> <span className="font-bold">{examId}</span>
                    </div>
                </div>
